...
from .engines.base import LLMResponse
from .engines.gguf_engine import GGUFEngine
...
from .engines.resonant_engine import ResonantEngine
from .engines.bi_camera_engine import BiCameraEngine
from .engines.qoop_engine import QoopEngine
...
class LLMAdapter:
    ...
    def infer(self, prompt, **kwargs):
        ...
        return LLMResponse("No Engine", 0,0,0)

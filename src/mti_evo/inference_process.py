...
class InferenceProcess(Process):
    ...
    def run(self):
        ...
        try:
            ...
            self.broca = MTIBroca(memory_backend="mmap")
            print(f"   ✅ Substrate loaded (mmap)")
    ...
    def _handle_request(self, request: dict):
        ...
        try:
            ...
            # 1. Resonance calculation (writes to mmap substrate)
    ...
    def _ensure_coherency(self):
        ...
        if sys.platform == 'win32':
            try:
                ...
                if hasattr(self.broca, 'hippocampus') and hasattr(self.broca.hippocampus, 'flush'):

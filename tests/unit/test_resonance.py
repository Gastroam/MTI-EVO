...
from resonance_loader import ResonanceModel
...
def test_resonance():
    print("[DEBUG] Starting Resonance Test...")
    ...
    try:
        model = ResonanceModel(MODEL_PATH)
    except Exception as e:
        print(f"[ERROR] Failed to init model: {e}")
        return
    
    total_savings = 0
    total_layers_full = 48
    ...
    print(f"\n[SUCCESS] Resonance Test Complete. Avg Savings: {avg_savings:.1f}%")
